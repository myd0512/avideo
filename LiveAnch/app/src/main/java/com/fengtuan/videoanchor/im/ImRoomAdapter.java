package com.fengtuan.videoanchor.im;
...
import com.fengtuan.videoanchor.view.ChatVoiceLayout;
import com.fengtuan.videoanchor.view.MyImageView;
                ...
                msg.setOnSendCompleteCallback(new BasicCallback() {
                    ...
                    public void gotResult(int responseCode, String responseDesc) {
                        ...
                        if (responseCode != 0) {
                            ...
                            L.e("极光IM---消息发送失败--->  responseDesc:" + responseCode);
                        }
                        notifyItemChanged(position, Constants.PAYLOAD);
                    }
                });
