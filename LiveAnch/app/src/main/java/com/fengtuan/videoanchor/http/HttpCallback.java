...
import com.fengtuan.videoanchor.activity.LoginInvalidActivity;
...
public abstract class HttpCallback extends AbsCallback<JsonBean> {
        ...
        if (bean != null) {
            if (200 == bean.getRet()) {
                ...
                if (data != null) {
                    ...
                    Log.e("HttpRequest","服务器返回值异常--->ret: " + bean.getRet() + " msg: " + bean.getMsg());
                    onError();
                }
            } else {
                Log.e("HttpRequest","服务器返回值异常--->ret: " + bean.getRet() + " msg: " + bean.getMsg());
            ...
            Log.e("HttpRequest","服务器返回值异常--->bean = null");
            onError();
        }
    }
    ...
    public void onError(Response<JsonBean> response) {
        ...
        Log.e("HttpRequest","网络请求错误---->" + t.getClass() + " : " + t.getMessage());
