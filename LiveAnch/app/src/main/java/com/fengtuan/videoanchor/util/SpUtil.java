...
public class SpUtil {
    ...
    //开播部分信息
    public static final String LIVE_THUMB = "liveThumbFile";
    public static final String LIVE_TITLE = "liveTitle";
    public static final String LIVE_CATEGORY_ID = "liveCategoryId";
    public static final String LIVE_CATEGORY_NAME = "liveCategoryName";
     ...
     * 获取一个字符串
     */
    public String getStringSValue(String key) {
