...
public class LiveKsyPushViewHolder extends AbsLivePushViewHolder implements
    ...
    @Override
    public void changeAudioMute(boolean isMute) {
        mIsMute = isMute ;
        if (mStreamer != null) {
            mStreamer.setMuteAudio(mIsMute);
        }
    }
     ...
     * 静音
     */
    public boolean changeVoiceMute(){
