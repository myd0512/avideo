...
import com.yunbao.liveanchor.bean.TxLocationBean;
import com.yunbao.liveanchor.bean.TxLocationPoiBean;
import com.yunbao.liveanchor.bean.UserBean;
import com.yunbao.liveanchor.event.FollowEvent;
import com.yunbao.liveanchor.interfa.CommonCallback;
import com.yunbao.liveanchor.util.L;
import com.yunbao.liveanchor.util.MD5Util;
...
//                            AppConfig.getInstance().setUserItemList(obj.getString("list"));
     ...
     * 获取主播今日直播时间和收益
     */
    public static void getLiveTimeReward(HttpCallback callback) {
        HttpClient.getInstance().get("User.user_today", HttpConsts.GET_LIVE_TIME_REWARD)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * 获取钱包信息
     */
    public static void getWalletInfo(HttpCallback callback) {
        HttpClient.getInstance().get("User.user_wallet", HttpConsts.GET_WALLET)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * 获取游戏种类信息
     */
    public static void getGameList(final CommonCallback<List<GameTypeBean>> callback) {
        HttpClient.getInstance().get("Game.get_game_start", HttpConsts.GET_GAME_LIST)
                .params("uid", AppConfig.getInstance().getUid())
                .params("token", AppConfig.getInstance().getToken())
                .execute(new HttpCallback() {
                    @Override
                    public void onSuccess(int code, String msg, String[] info) {
                        if(info != null && info.length > 0){
                            ...
                            List<GameTypeBean> gameList = new ArrayList<>() ;
                            for(String str : info){
                                gameList.add(ParseUtils.parseJson(str,GameTypeBean.class)) ;
                            }
                            if(callback != null){
                                callback.callback(gameList) ;
                            }
                        }else{
                            if(callback != null){
     ...
     * @param callback
     */
    public static void createRoom(String title, int liveClassId, int type, int typeVal,String gameId, File file, HttpCallback callback) {
        ...
        LogUtil.e("createRoomParam",request.getParams().toString()) ;
...
//    }
     ...
     * 获取用户的直播记录
     */
    public static void getSelfLiveRecord(int p, HttpCallback callback) {
        HttpClient.getInstance().get("User.getLiverecord", HttpConsts.GET_LIVE_RECORD)
...
//     *   一分快三用户下注
//     */
//    public static void gameYfksLog(String yfks_id,String type,String code,String totalcoin,String odds,String magnification, HttpCallback callback){
//        HttpClient.getInstance().get("Game.user_yfks_log",HttpConsts.GAME_YFKS_LOG)
//                .params("name","game")
//                .params("uid",AppConfig.getInstance().getUid())
//                .params("yfks_id",yfks_id)
//                .params("type",type)
//                .params("code",code)
//                .params("totalcoin",totalcoin)
//                .params("odds",odds)
...
//     *   一分11选5用户下注
//     */
//    public static void gameYf115Log(String yfks_id,String type,String code,String totalcoin,String odds,String magnification, HttpCallback callback){
//        HttpClient.getInstance().get("Game.user_yf115_log",HttpConsts.GAME_YF115_LOG)
//                .params("name","game")
//                .params("uid",AppConfig.getInstance().getUid())
//                .params("yf115_id",yfks_id)
//                .params("type",type)
//                .params("code",code)
//                .params("totalcoin",totalcoin)
//                .params("odds",odds)
...
//     *   一分快三用户下注
//     */
//    public static void gameYflhcLog(String yfks_id,String type,String code,String totalcoin,String odds,String magnification, HttpCallback callback){
//        HttpClient.getInstance().get("Game.user_yflhc_log",HttpConsts.GAME_YFKS_LOG)
//                .params("name","game")
//                .params("uid",AppConfig.getInstance().getUid())
//                .params("yflhc_id",yfks_id)
//                .params("type",type)
//                .params("code",code)
//                .params("totalcoin",totalcoin)
//                .params("odds",odds)
...
//     *   一分快三用户下注
//     */
//    public static void gameYfscLog(String yfks_id,String type,String code,String totalcoin,String odds,String magnification, HttpCallback callback){
//        HttpClient.getInstance().get("Game.user_yfsc_log",HttpConsts.GAME_YFSC_LOG)
//                .params("name","game")
//                .params("uid",AppConfig.getInstance().getUid())
//                .params("yfsc_id",yfks_id)
//                .params("type",type)
//                .params("code",code)
//                .params("totalcoin",totalcoin)
//                .params("odds",odds)
...
//     *   一分快三用户下注
//     */
//    public static void gameYfsscLog(String yfks_id,String type,String code,String totalcoin,String odds,String magnification, HttpCallback callback){
//        HttpClient.getInstance().get("Game.user_yfssc_log",HttpConsts.GAME_YFSSC_LOG)
//                .params("name","game")
//                .params("uid",AppConfig.getInstance().getUid())
//                .params("yfssc_id",yfks_id)
//                .params("type",type)
//                .params("code",code)
//                .params("totalcoin",totalcoin)
//                .params("odds",odds)
...
//     *   一分快三用户下注
//     */
//    public static void gameYfklsfLog(String yfks_id,String type,String code,String totalcoin,String odds,String magnification, HttpCallback callback){
//        HttpClient.getInstance().get("Game.user_yfklsf_log",HttpConsts.GAME_YFKS_LOG)
//                .params("name","game")
//                .params("uid",AppConfig.getInstance().getUid())
//                .params("yfklsf_id",yfks_id)
//                .params("type",type)
//                .params("code",code)
//                .params("totalcoin",totalcoin)
//                .params("odds",odds)
...
//     *   一分快三用户下注
//     */
//    public static void gameYfxyncLog(String yfks_id,String type,String code,String totalcoin,String odds,String magnification, HttpCallback callback){
//        HttpClient.getInstance().get("Game.user_yfxync_log",HttpConsts.GAME_YFKS_LOG)
//                .params("name","game")
//                .params("uid",AppConfig.getInstance().getUid())
//                .params("yfxync_id",yfks_id)
//                .params("type",type)
//                .params("code",code)
//                .params("totalcoin",totalcoin)
//                .params("odds",odds)
...
//     *   基本信息
//     *   url:游戏的链接
//     *   Game.get_yfks_info     一分快三
//     *   Game.get_yflhc_info    一分六合
//     *   Game.get_yf115_info    一分11选5
//     *   Game.get_yfsc_info     一分赛车
//     *   Game.get_yfssc_info    一分时时彩
//     *
//     *   tag:游戏标识
//     *   GAME_YFKS_INFO     一分快三
//     *   GAME_YFLHC_INFO    一分六合
//     *   GAME_YF115_INFO    一分11选5
//     *   GAME_YFSC_INFO     一分赛车
//     *   GAME_YFSSC_INFO    一分时时彩
//     */
...
//
     ...
     * 获取礼物记录
     */
    public static void getGiftRecord(HttpCallback callback){
        HttpClient.getInstance().get("Live.getHostGiftLog",HttpConsts.GIFT_LOG)
                .params("liveuid",AppConfig.getInstance().getUid())
                .execute(callback);
    }
