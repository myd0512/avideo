...
import com.yunbao.liveanchor.view.VerticalImageSpan;
        ...
        ImgLoader.displayDrawable2(levelBean.getThumb(), new ImgLoader.DrawableCallback() {
            ...
            public void callback(Drawable drawable) {
                ...
                if (textView != null) {
                    ...
                    Log.e(TextRender.class.getSimpleName(),builder.toString());
...
//                    builder.append(bean.getContent());
     ...
     * @param sizeDp sizeDp
     */
    public static void convertMoneyText(TextView tv,String money,int sizeDp){
        if(tv != null){
            ...
            sp.setSpan(new AbsoluteSizeSpan(sizeDp,true),money.length()-2,money.length(), Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
            tv.setText(sp);
        }
    }
    /**
     * 生成系统+跟投前缀
     */
    public static SpannableStringBuilder createPrefix(String content,int id) {
        Drawable drawableSystem=ContextCompat.getDrawable(AppContext.sInstance,id);
        SpannableStringBuilder builder = new SpannableStringBuilder();
        builder.append("  ");
