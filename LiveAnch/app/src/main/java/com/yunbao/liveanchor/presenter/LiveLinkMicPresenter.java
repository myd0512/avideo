...
import com.yunbao.liveanchor.interfa.ILiveLinkMicViewHolder;
import com.yunbao.liveanchor.interfa.LivePushListener;
import com.yunbao.liveanchor.socket.SocketClient;
import com.yunbao.liveanchor.socket.SocketLinkMicUtil;
...
import com.yunbao.liveanchor.view.LiveLinkMicPlayViewHolder;
import com.yunbao.liveanchor.view.LiveLinkMicPushViewHolder;
...
//            btnLinkMic.setVisibility(View.VISIBLE);
            btnLinkMic.setVisibility(View.GONE);
    ...
    private void checkLinkMicEnable() {
        HttpUtil.checkLinkMicEnable(mLiveUid, new HttpCallback() {
            @Override
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0) {
    ...
    public void clearData() {
        HttpUtil.cancel(HttpConsts.CHECK_LINK_MIC_ENABLE);
        mIsLinkMic = false;
        mIsLinkMicDialogShow = false;
        mAcceptLinkMic = false;
        mLastApplyLinkMicTime = 0;
