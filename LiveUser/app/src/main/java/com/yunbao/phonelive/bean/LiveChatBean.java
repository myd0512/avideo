...
public class LiveChatBean {
    ...
    public static final int TZ_FOLLOW = 6;
    public static final int ZJ_LIST = 7;
    ...
    public String getGameItemIds() {
        if(!TextUtils.isEmpty(mGameItemIds) && mGameItemIds.startsWith(",")){
            return mGameItemIds.substring(1) ;
        }
        return mGameItemIds;
    }

    public void setGameItemIds(String mGameItemIds) {
        this.mGameItemIds = mGameItemIds;
    }
