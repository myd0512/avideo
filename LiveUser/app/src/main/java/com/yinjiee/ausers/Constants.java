...
public class Constants {
    ...
    public static final String LIVE_GAME_NAME = "liveGameName";
    public static final String LIVE_GAME_NAME_TZ = "liveTzGameName";
    public static final String LIVE_GAME_NAME_TZ_IDS = "liveTzGameNameIds";
    public static final String LIVE_GAME_NAME_TZ_LIST = "liveTzGameList";
    public static final String LIVE_GAME_NAME_TZ_PERIOD = "liveTzGamePeriod";
    public static final String LIVE_GAME_ID = "liveGameID";
    public static final String LIVE_GAME_TIMESEC = "timeSec";
    public static final String LIVE_GAME_IGAMEURL = "liveGameImageUrl";
    public static final String LIVE_GAME_IS_LIVE = "liveGameIsLive";
    public static final String LIVE_GAME_TYPE = "liveGameType";
    ...
    public static final int SETTING_MODIFY_PWD = 13;
    ...
    public static final String SOCKET_SYSTEM_TZ = "SystemNotTz";//系统消息投注
    public static final String SOCKET_SYSTEM_ZJ = "SystemNotZj";//系统消息中奖
