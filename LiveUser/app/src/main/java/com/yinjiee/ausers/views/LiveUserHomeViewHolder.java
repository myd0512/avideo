...
import com.yinjiee.ausers.activity.ChatRoomActivity;
import com.yinjiee.ausers.activity.FansActivity;
import com.yinjiee.ausers.activity.FollowActivity;
import com.yinjiee.ausers.activity.LiveContributeActivity;
import com.yinjiee.ausers.activity.LiveGuardListActivity;
...
import com.yinjiee.ausers.bean.UserHomeConBean;
import com.yinjiee.ausers.custom.MyTextView;
import com.yinjiee.ausers.custom.MyViewPager;
import com.yinjiee.ausers.custom.ViewPagerIndicator;
...
import com.yinjiee.ausers.interfaces.LifeCycleListener;
import com.yinjiee.ausers.presenter.UserHomeSharePresenter;
        ...
        HttpUtil.getUserHome(mToUid, new HttpCallback() {
            ...
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0 && info.length > 0) {
                    ...
                    mVotesName.setText("礼物" + WordUtil.getString(R.string.live_user_home_con));
