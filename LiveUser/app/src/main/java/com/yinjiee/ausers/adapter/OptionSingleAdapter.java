...
public class OptionSingleAdapter extends RecyclerView.Adapter<OptionSingleAdapter.Vh> {
    ...
    public OptionSingleAdapter(Context context, LayoutInflater inflater, String parentName, String value, List<OptionBean> list) {
    ...
    public Vh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Vh(mInflater.inflate(R.layout.item_option_single, null, false));
    }
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        public Vh(View itemView) {
            ...
            pName = itemView.findViewById(R.id.tv_parent_name);
