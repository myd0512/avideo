package com.yinjiee.ausers.game.views;
...
import com.yinjiee.game.custom.GameBetCoinView;
import com.yinjiee.game.custom.PokerView;
import com.yinjiee.game.util.GameIconUtil;
...
import com.yinjiee.ausers.game.GameSoundPool;
import com.yinjiee.ausers.game.bean.BankerBean;
import com.yinjiee.ausers.game.bean.GameParam;
import com.yinjiee.ausers.game.dialog.GameNzLsDialogFragment;
import com.yinjiee.ausers.game.dialog.GameNzSfDialogFragment;
import com.yinjiee.ausers.game.dialog.GameNzSzDialogFragment;
import com.yinjiee.ausers.game.socket.SocketGameUtil;
...
public class GameNzViewHolder extends AbsGameViewHolder {
    ...
    public void release() {
        ...
        HttpUtil.cancel(HttpConsts.GAME_NIUZAI_CREATE);
        HttpUtil.cancel(HttpConsts.GAME_NIUZAI_BET);
